...
impl_enum_strings(eSpriteAnimationID)
{
    ...
    {eSpriteAnimationID_Ped_SittingInCar, "ped_sitting_in_car"},
    {eSpriteAnimationID_Ped_ExitBike, "ped_exit_bike"},
    {eSpriteAnimationID_Ped_EnterBike, "ped_enter_bike"},
    {eSpriteAnimationID_Ped_SittingOnBike, "ped_sitting_on_bike"},
